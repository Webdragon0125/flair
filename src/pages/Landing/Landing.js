...
import SelPassengerMobile from '../../components/SelPassengerMobile/SelPassengerMobile';
import MobilePassengerSelect from '../../components/MobilePassengerSelect/MobilePassengerSelect';
...
const Landing = () => {
  ...
  const [displayFlag3, setDisplayFlag3] = useState(false);
  ...
  const [posi1, setPosi1] = useState(0);
  const [posi2, setPosi2] = useState(1);
  ...
  return (
    <Wrapper onClick={wrapperClicked} bgImg={IMG_BACK}>
      <div className="landing-first">
          ...
          <div>
            ...
            <div className="search-location-mobile">
              <div onClick={() => setDisplayFlag1(true)}>
                <MobileFormDiv props={{ flag: 0, ...options[posi1] }}></MobileFormDiv>
              </div>
              <div onClick={() => setDisplayFlag2(true)}>
                <MobileFormDiv props={{ flag: 1, ...options[posi2] }}></MobileFormDiv>
              </div>
            ...
            <div onClick={() => setDisplayFlag3(true)}>
              <SelPassengerMobile props={{ cntper: cntper }}></SelPassengerMobile>
            </div>
         ...
         * Mobile components
         */}
        <MobileLocationSearch props={{ displayFlag: displayFlag1, setDisplayFlag: setDisplayFlag1, options: options, posi: posi1, setPosi: setPosi1 }}></MobileLocationSearch>
        <MobileLocationSearch props={{ displayFlag: displayFlag2, setDisplayFlag: setDisplayFlag2, options: options, posi: posi2, setPosi: setPosi2 }}></MobileLocationSearch>
        <MobilePassengerSelect props={{ displayFlag: displayFlag3, setDisplayFlag: setDisplayFlag3, cntper: cntper, setCntper: setCntper }}></MobilePassengerSelect>
        {/**
